...
- `rust_tui/src/bin/codex_overlay/config.rs` - `VoiceSendMode` enum
- `rust_tui/src/bin/codex_overlay/main.rs:220-236` - Toggle handling
- `rust_tui/src/bin/codex_overlay/transcript.rs:131-150` - Mode-specific send paths
